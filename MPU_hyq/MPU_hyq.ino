#include <Wire.h>
#include "I2C.h" // Source: https://github.com/TKJElectronics/KalmanFilter
...
void setup() {  
  ...
  accX = ((i2c.i2cData[0] << 8) | i2c.i2cData[1]);
  accY = ((i2c.i2cData[2] << 8) | i2c.i2cData[3]);
  accZ = ((i2c.i2cData[4] << 8) | i2c.i2cData[5]);
...
void loop() {
  ...
  while(i2c.i2cRead(0x3B,i2c.i2cData,14));
  accX = ((i2c.i2cData[0] << 8) | i2c.i2cData[1]);
  accY = ((i2c.i2cData[2] << 8) | i2c.i2cData[3]);
  accZ = ((i2c.i2cData[4] << 8) | i2c.i2cData[5]);
  tempRaw = ((i2c.i2cData[6] << 8) | i2c.i2cData[7]);  
  gyroX = ((i2c.i2cData[8] << 8) | i2c.i2cData[9]);
  gyroY = ((i2c.i2cData[10] << 8) | i2c.i2cData[11]);
  gyroZ = ((i2c.i2cData[12] << 8) | i2c.i2cData[13]);
